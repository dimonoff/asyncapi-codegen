//go:generate go run ../../../../../cmd/asyncapi-codegen -g publisher,types -p main -i ../../asyncapi.yaml -o ./publisher.gen.go
...
import (
	...
	"github.com/dimonoff/asyncapi-codegen/pkg/extensions/brokers/nats"
...
var _ PublisherSubscriber = (*Subscriber)(nil)
...
func main() {
	...
	ctrl, err := NewPublisherController(
	...
	// Listen on port to let know that server is ready
