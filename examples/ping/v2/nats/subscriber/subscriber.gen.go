...
func (c *SubscriberController) SubscribePong(
	ctx context.Context,
...
func (c *SubscriberController) listenToPongNextMessage(
	path string,
...
func (c *SubscriberController) UnsubscribePong(ctx context.Context) {
	// Get channel path
	path := "pong.v2"
...
func (c *SubscriberController) PublishPing(
	ctx context.Context,
	msg PingMessage,
) error {
	// Get channel path
...
//
// A timeout can be set in context to avoid blocking operation, if needed.
func (c *SubscriberController) WaitForPong(
	ctx context.Context,
...
func (c *SubscriberController) waitForPongNextMessage(
	ctx context.Context,
	path string,
	sub extensions.BrokerChannelSubscription,
	publishMsg MessageWithCorrelationID,
