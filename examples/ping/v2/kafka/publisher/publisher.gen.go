...
func (c *PublisherController) SubscribePing(
	ctx context.Context,
...
func (c *PublisherController) listenToPingNextMessage(
	path string,
...
func (c *PublisherController) UnsubscribePing(ctx context.Context) {
	// Get channel path
	path := "ping.v2"
...
func (c *PublisherController) PublishPong(
	ctx context.Context,
	msg PongMessage,
) error {
	// Get channel path
