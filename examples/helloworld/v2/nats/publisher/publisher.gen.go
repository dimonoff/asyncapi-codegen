...
func (c *PublisherController) SubscribeHello(
	ctx context.Context,
...
func (c *PublisherController) listenToHelloNextMessage(
	path string,
...
func (c *PublisherController) UnsubscribeHello(ctx context.Context) {
	// Get channel path
	path := "hello"
