...
func (c *PublisherController) SubscribeToReceiveHelloOperation(
	ctx context.Context,
...
func (c *PublisherController) listenToReceiveHelloOperationNextMessage(
	addr string,
...
func (c *PublisherController) UnsubscribeFromReceiveHelloOperation(
	ctx context.Context,
) {
	// Get channel address
	addr := "hello"
