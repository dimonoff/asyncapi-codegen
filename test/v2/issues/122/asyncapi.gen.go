...
func (c *PublisherController) SubscribeV2Issue122Msg(
	ctx context.Context,
...
func (c *PublisherController) listenToV2Issue122MsgNextMessage(
	path string,
...
func (c *PublisherController) UnsubscribeV2Issue122Msg(ctx context.Context) {
	// Get channel path
	path := "v2.issue122.msg"
...
func (c *SubscriberController) PublishV2Issue122Msg(
	ctx context.Context,
