...
func (c *PublisherController) PublishV2Issue245Test(
	ctx context.Context,
...
func (c *SubscriberController) SubscribeV2Issue245Test(
	ctx context.Context,
...
func (c *SubscriberController) listenToV2Issue245TestNextMessage(
	path string,
...
func (c *SubscriberController) UnsubscribeV2Issue245Test(ctx context.Context) {
	// Get channel path
	path := "v2.issue245.test"
