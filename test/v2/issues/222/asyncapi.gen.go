...
func (c *PublisherController) PublishV2Issue222Test(
	ctx context.Context,
...
func (c *SubscriberController) SubscribeV2Issue222Test(
	ctx context.Context,
...
func (c *SubscriberController) listenToV2Issue222TestNextMessage(
	path string,
...
func (c *SubscriberController) UnsubscribeV2Issue222Test(ctx context.Context) {
	// Get channel path
	path := "v2.issue222.test"
