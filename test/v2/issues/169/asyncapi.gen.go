...
func (c *PublisherController) SubscribeV2Issue169Msg(
	ctx context.Context,
...
func (c *PublisherController) listenToV2Issue169MsgNextMessage(
	path string,
...
func (c *PublisherController) UnsubscribeV2Issue169Msg(ctx context.Context) {
	// Get channel path
	path := "v2.issue169.msg"
...
func (c *SubscriberController) PublishV2Issue169Msg(
	ctx context.Context,
