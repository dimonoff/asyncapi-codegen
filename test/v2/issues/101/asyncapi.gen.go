...
func (c *PublisherController) SubscribeV2Issue101Test(
	ctx context.Context,
...
func (c *PublisherController) listenToV2Issue101TestNextMessage(
	path string,
...
func (c *PublisherController) UnsubscribeV2Issue101Test(ctx context.Context) {
	// Get channel path
	path := "v2.issue101.test"
...
func (c *SubscriberController) PublishV2Issue101Test(
	ctx context.Context,
