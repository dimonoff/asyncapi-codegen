...
func (c *PublisherController) SubscribeV2Issue164TestMap(
	ctx context.Context,
...
func (c *PublisherController) listenToV2Issue164TestMapNextMessage(
	path string,
...
func (c *PublisherController) UnsubscribeV2Issue164TestMap(ctx context.Context) {
	// Get channel path
	path := "v2.issue164.testMap"
...
func (c *SubscriberController) PublishV2Issue164TestMap(
	ctx context.Context,
	msg TestMapMessage,
) error {
	// Get channel path
