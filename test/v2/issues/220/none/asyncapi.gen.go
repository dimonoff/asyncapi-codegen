...
func (c *PublisherController) PublishV2Issue220Test(
	ctx context.Context,
...
func (c *SubscriberController) SubscribeV2Issue220Test(
	ctx context.Context,
...
func (c *SubscriberController) listenToV2Issue220TestNextMessage(
	path string,
...
func (c *SubscriberController) UnsubscribeV2Issue220Test(ctx context.Context) {
	// Get channel path
	path := "v2.issue220.test"
