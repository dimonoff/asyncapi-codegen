...
func (c *PublisherController) PublishV2Issue131Test(
	ctx context.Context,
...
func (c *SubscriberController) SubscribeV2Issue131Test(
	ctx context.Context,
...
func (c *SubscriberController) listenToV2Issue131TestNextMessage(
	path string,
...
func (c *SubscriberController) UnsubscribeV2Issue131Test(ctx context.Context) {
	// Get channel path
	path := "v2.issue131.test"
