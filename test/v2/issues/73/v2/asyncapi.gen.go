...
func (c *PublisherController) SubscribeV2Issue73Hello(
	ctx context.Context,
...
func (c *PublisherController) listenToV2Issue73HelloNextMessage(
	path string,
...
func (c *PublisherController) UnsubscribeV2Issue73Hello(ctx context.Context) {
	// Get channel path
	path := "v2.issue73.hello"
...
func (c *SubscriberController) PublishV2Issue73Hello(
	ctx context.Context,
