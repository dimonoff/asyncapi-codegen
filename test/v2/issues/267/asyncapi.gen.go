...
func (c *PublisherController) PublishV2Issue267Test(
	ctx context.Context,
...
func (c *SubscriberController) SubscribeV2Issue267Test(
	ctx context.Context,
...
func (c *SubscriberController) listenToV2Issue267TestNextMessage(
	path string,
...
func (c *SubscriberController) UnsubscribeV2Issue267Test(ctx context.Context) {
	// Get channel path
	path := "v2.issue267.test"
