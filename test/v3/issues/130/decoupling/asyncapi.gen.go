...
func (c *PublisherController) SubscribeToConsumeUserSignupOperation(
	ctx context.Context,
...
func (c *PublisherController) listenToConsumeUserSignupOperationNextMessage(
	addr string,
...
func (c *PublisherController) UnsubscribeFromConsumeUserSignupOperation(
	ctx context.Context,
) {
	// Get channel address
	addr := "v3.issue130.user.signedup"
...
// NOTE: for now, this only support the first message from AsyncAPI list.
// If you need support for other messages, please raise an issue.
func (c *SubscriberController) SendToConsumeUserSignupOperation(
	ctx context.Context,
