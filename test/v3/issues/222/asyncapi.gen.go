...
func (c *PublisherController) SubscribeToHandleTestingOperation(
	ctx context.Context,
...
func (c *PublisherController) listenToHandleTestingOperationNextMessage(
	addr string,
...
func (c *PublisherController) UnsubscribeFromHandleTestingOperation(
	ctx context.Context,
) {
	// Get channel address
	addr := "v3.issue222.test"
...
// NOTE: for now, this only support the first message from AsyncAPI list.
// If you need support for other messages, please raise an issue.
func (c *SubscriberController) SendToHandleTestingOperation(
	ctx context.Context,
