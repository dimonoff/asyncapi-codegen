...
func (c *PublisherController) SubscribeToHandlingTestingOperation(
	ctx context.Context,
...
func (c *PublisherController) listenToHandlingTestingOperationNextMessage(
	addr string,
...
func (c *PublisherController) UnsubscribeFromHandlingTestingOperation(
	ctx context.Context,
) {
	// Get channel address
	addr := "v3.issue220.test"
...
// NOTE: for now, this only support the first message from AsyncAPI list.
// If you need support for other messages, please raise an issue.
func (c *SubscriberController) SendToHandlingTestingOperation(
	ctx context.Context,
