...
func (c *PublisherController) SubscribeToPingRequestOperation(
	ctx context.Context,
...
func (c *PublisherController) listenToPingRequestOperationNextMessage(
	addr string,
...
func (c *PublisherController) ReplyToPingRequestOperation(ctx context.Context, recvMsg PingMessage, fn func(replyMsg *PongMessage)) error {
...
func (c *PublisherController) UnsubscribeFromPingRequestOperation(
	ctx context.Context,
) {
	// Get channel address
	addr := "v3.issue145.ping"
...
// NOTE: for now, this only support the first message from AsyncAPI list.
// If you need support for other messages, please raise an issue.
func (c *PublisherController) SendAsReplyToPingRequestOperation(
	ctx context.Context,
	chanAddr string,
	msg PongMessage,
) error {
...
// NOTE: for now, this only support the first message from AsyncAPI list.
// If you need support for other messages, please raise an issue.
func (c *SubscriberController) SendToPingRequestOperation(
	ctx context.Context,
	msg PingMessage,
) error {
	// Set channel address
...
func (c *SubscriberController) RequestToPingRequestOperation(
	ctx context.Context,
	msg PingMessage,
) (PongMessage, error) {
...
func (c *SubscriberController) waitForPingRequestOperationNextResponse(
	ctx context.Context,
	addr string,
	sub extensions.BrokerChannelSubscription,
) (*PongMessage, error) {
