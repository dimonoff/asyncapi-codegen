...
func (c *PublisherController) SubscribeToTestMapOperation(
	ctx context.Context,
...
func (c *PublisherController) listenToTestMapOperationNextMessage(
	addr string,
...
func (c *PublisherController) UnsubscribeFromTestMapOperation(
	ctx context.Context,
) {
	// Get channel address
	addr := "v3.issue164.testMap"
...
// NOTE: for now, this only support the first message from AsyncAPI list.
// If you need support for other messages, please raise an issue.
func (c *SubscriberController) SendToTestMapOperation(
	ctx context.Context,
	msg TestMapMessage,
) error {
	// Set channel address
