...
const (
	// ScheduleEventsChannelPath is the constant representing the 'ScheduleEventsChannel' channel path.
	ScheduleEventsChannelPath = "regions.{regionId}.projects.{projectId}.topics.schedule-published"
)

// ChannelsPaths is an array of all channels paths
var ChannelsPaths = []string{
	ScheduleEventsChannelPath,
}
